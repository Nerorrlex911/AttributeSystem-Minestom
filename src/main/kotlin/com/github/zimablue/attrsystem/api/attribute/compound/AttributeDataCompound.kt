...
class AttributeDataCompound : LowerMap<AttributeData> {
    ...
    fun hasAttribute(key: String): Boolean {
        return hasAttribute(AttributeSystem.attributeManager[key] ?: return false)
    }
    ...
    operator fun get(key: String, attribute: String): Status<*>? {
        val attribute1: Attribute = AttributeSystem.attributeManager[attribute] as Attribute
     ...
     * @return 物品
     */
    fun saveTo(itemStack: ItemStack) : ItemStack {
        val tagNBT = Tag.NBT("ATTRIBUTE_DATA")
        return itemStack.withTag(tagNBT, toNBT(this.serialize()))
    }
    ...
    fun <T> getAttrValue(
        ...
        return getAttrValue(AttributeSystem.attributeManager[attribute] ?: return null, entity, placeholder)
    }
